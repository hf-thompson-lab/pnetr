test_that("Match PnET-II w/ MATLAB result", {
    ...
    expect_equal(mon_dt$NetPsnMo, out_li$netpsn, tolerance = 0.001)
    ...
    expect_equal(mon_dt$Drainage, out_li$drainage, tolerance = 0.001)
    expect_equal(mon_dt$ET, out_li$et, tolerance = 0.001)

    # Annual output
    expect_equal(ann_dt$NPPFolYr, out_li$nppfol, tolerance = 0.01)
    expect_equal(ann_dt$NPPWoodYr, out_li$nppwood, tolerance = 0.001)
